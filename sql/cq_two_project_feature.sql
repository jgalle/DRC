--File Name: CQ2_Project_FeatureRelated_DRC_Done
--Created by: Jillian Galle
--Last Updated: 15 April 2015 by jeg


--Query Description: User selects one or more Projects and Feature data in Related View.
...
create view cq_two_project_feaures as
SELECT
