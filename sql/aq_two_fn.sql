...
--Beads--
create view aq_two_feature_numbers as
SELECT
...
WHERE
					...
					--Step 1: Feature Number Users select "All Feature Numbers" OR one or more feature numbers for that project through a text box with wildcard search option.
					and "e"."FeatureNumber" IN ('F01', 'F02',' F03')
