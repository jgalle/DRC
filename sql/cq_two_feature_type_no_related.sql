--File Name: CQ2_FeatureType_NoRelatedData_DRC_Done
--Created by: Jillian Galle
--Last Updated: 15 June 2015 by jeg

--Query Description: User selects one or more Projects and one or more feature types.
...
create view cq_two_feature_type_no_relateds as
SELECT
