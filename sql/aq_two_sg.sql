...
--Beads--
create view aq_two_strat_groups as
SELECT
...
WHERE
					...
					--Step 1: Stratigraphic Group Users select "All SGs" OR one or more SGs for that project through a text box with wildcard search option.
					and "c"."DAACSStratigraphicGroup"  IN ('SG01','SG02')
