create view query_faunal_two_feature_numbers as
SELECT
...
"public"."tblContextFeature"."FeatureGroup" AS "Feature Group",
...
"UnitType",
"FeatureType",
"tblContextFeature"."FeatureNumber",
"Feature Group",
...
"BodyPart",
"Element",
"tblBoneSymmetry"."SymmetryExpand",
"NISP",
"BoneWeight",
"BoneLocation",
"BoneDescriptor",
...
"SexExpand",
"ChewTypeExpand",
"tblBoneChewLocation"."ChewLocationExpand",
"FreshBreak",
"ToothTypeExpand",
"ToothWear",
"DiseaseTrauma",
...
"NumberCutMarks",
"ButcherMethodExpand",
"ButcherLocationExpand",
"ButcherDirectionExpand",
"CutType",
"CutLocation",
"CutDirection",
"Meat WeightAdult",
