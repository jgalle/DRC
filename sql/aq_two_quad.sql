--Beads--
create view aq_two_quadrat_beads as
SELECT
...
--Buckles--
create view aq_two_quadrat_buckles as
SELECT
"b"."ProjectName" AS "ProjectName",
"a"."ProjectID" AS "ProjectID",
"c"."QuadratID" AS "QuadratID",
...
--Buttons--
create view aq_two_quadrat_buttons as
SELECT
"b"."ProjectName" AS "ProjectName",
"a"."ProjectID" AS "ProjectID",
"c"."QuadratID" AS "QuadratID",
...
--Ceramics--
create view aq_two_quadrat_ceramics as
SELECT
"b"."ProjectName" AS "ProjectName",
"a"."ProjectID" AS "ProjectID",
"c"."QuadratID" AS "QuadratID",
...
--Faunal--
create view aq_two_qaudrat_bones as
SELECT
"b"."ProjectName" AS "ProjectName",
"a"."ProjectID" AS "ProjectID",
"c"."QuadratID" AS "QuadratID",
...
--General Artifacts--
create view aq_two_quadrat_gen_artifacts as
SELECT
"b"."ProjectName" AS "ProjectName",
"a"."ProjectID" AS "ProjectID",
"c"."QuadratID" AS "QuadratID",
...
--Glass--
create view aq_two_quadrat_glasses as
SELECT
"b"."ProjectName" AS "ProjectName",
"a"."ProjectID" AS "ProjectID",
"c"."QuadratID" AS "QuadratID",
...
--Tobacco Pipes--
create view aq_two_quadrat_tobacco_pipes as
SELECT
"b"."ProjectName" AS "ProjectName",
"a"."ProjectID" AS "ProjectID",
"c"."QuadratID" AS "QuadratID",
...
--Utensils--
create view aq_two_quadrat_utensils as
SELECT
"b"."ProjectName" AS "ProjectName",
"a"."ProjectID" AS "ProjectID",
"c"."QuadratID" AS "QuadratID",
