--File Name: CQ2_UnitType_QuadratBoundaryRelatedData_DAACS_Done
--Created by: Jillian Galle
--Last Updated: 9 April 2015 by jeg

--Query Description: User selects one or more Projects, Unit Types, and Quadrat Boundary Data in Related View.
...
--3.This query returns Quadrat Boundary Data in Related DATA View
--4.This Query is for the DAACS Website.

create view cq_two_unit_type_quadrats as
SELECT
