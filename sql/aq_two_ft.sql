...
--Beads--
create view aq_two_feature_types as
SELECT
...
WHERE
					...
					-- Step 1: Feature Type Selection. Users select "All Feature Types" 
					--and "f"."FeatureType" is Not Null

					--OR one or more Feature Number for that project through a text box with wildcard search option.
					and "f"."FeatureType"  IN ('Paving, brick','Pit, subfloor(< 28 sq.ft)')
