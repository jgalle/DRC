--File Name: CQ2_FeatureNumber_FeatureRelated_DRC_Done
--Created by: Jillian Galle
--Last Updated: 15 April 2015 by jeg

--Query Description: User selects one or more Projects, Feature data and one or more feature numbers.
...
create view cq_two_feature_number_features as
SELECT
