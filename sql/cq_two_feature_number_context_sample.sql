--File Name: CQ2_FeatureNumber_ContextSampleRelated_DRC_Done
--Created by: Jillian Galle
--Last Updated: 15 April 2015 by jeg

--Query Description: User selects one or more Projects, Context Sample data and one or more feature numbers.
...
--3.This query returns Context Sample Data in Related DATA View
--4.This Query is for the DRC Website.

create view cq_two_feature_number_context_samples as
SELECT
