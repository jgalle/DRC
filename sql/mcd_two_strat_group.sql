--File Name: 	MCDQ2_StratGroups_DRC_Done
--Created by: Jillian Galle
--Last Updated: 7 April 2015 by jeg

--Query Description: User selects one or more Projects and Strat Groups. Returns all Ware Type Frequency DATA.
--User notes: This Query is for the DRC Website.
create view mcd_two_strat_groups as
SELECT
a."ProjectID",
a."Published",
"b"."ProjectName",
