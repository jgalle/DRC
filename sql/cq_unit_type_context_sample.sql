--File Name: CQ2_UnitType_ContextSampleRelated_DRC_Done
--Created by: Jillian Galle
--Last Updated: 15 April 2015 by jeg

--Query Description: User selects one or more Projects, Unit Types, and Context Sample Data in Related View.
...
create view cq_two_unit_type_context_samples as
SELECT
