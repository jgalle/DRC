--File Name: CQ2_Project_SedimentInclusionData_DRC_Done
--Created by: Jillian Galle
--Last Updated: 15 April 2015 by jeg

--Query Description: User selects one or more Projects and Sediment/Inclusion Data in Related View.
...
create view cq_two_project_sediments as
SELECT
