--File Name: CQ2_UnitType_STPData_DRC_Done
--Created by: Jillian Galle
--Last Updated: 15 June 2015 2015 by jeg


--Query Description: User selects one or more Unit Types and STP data in Related View.
...
create view cq_two_unit_type_stps as
SELECT
...
--Unit Type Selection 
"g"."UnitType" ='STP' --No other OPTION is allowed
