...
--Beads--
create view aq_two_feature_groups as
SELECT
...
WHERE
					...
					--Step 1: Feature Group. Users select "All FGS" OR one or more feature Groups for that project through a text box with wildcard search option.
					and "e"."FeatureGroup" IN ('FG01', 'FG02')
