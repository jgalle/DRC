--File Name: CQ2_FeatureNumber_ElevationRelatedData_DRC_Done
--Created by: Jillian Galle
--Last Updated: 13 April 2015 by jeg

--Query Description: User selects one or more Projects, elevation data and one or more feature numbers.
...
create view cq_two_feature_number_elevation_relateds as
SELECT
