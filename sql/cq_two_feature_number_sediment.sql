--File Name: CQ2_FeatureNumber_SedimentInclusionData_DRC_Done
--Created by: Jillian Galle
--Last Updated: 15 April 2015 by jeg

--Query Description: User selects one or more Projects, Sediment/Inclusion data and one or more feature numbers.
...
create view cq_two_feature_number_sediments as
SELECT
