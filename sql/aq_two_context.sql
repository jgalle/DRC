...
--Beads--
create view aq_two_contexts as
SELECT
...
WHERE
					...
					--Step 1: Context Selection. Users select "All Contexts" OR one or more Contexts for that project through a text box with wildcard search option.
						AND "c"."Context" IN ('408B', '998F') 
