--File Name: CQ2_Project_QuadratBoundariesRelatedData_DRC_Done
--Created by: Jillian Galle
--Last Updated: 9 April 2015 by jeg

--Query Description: User selects one or more Projects and Quadrat Boundary Data in Related View.
...
create view cq_two_project_quadrats as
SELECT
