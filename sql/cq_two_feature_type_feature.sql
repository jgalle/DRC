--File Name: CQ2_FeatureType_FeatureRelated_DRC_Done
--Created by: Jillian Galle
--Last Updated: 13 April 2015 by jeg

--Query Description: User selects one or more Projects, Feature data, and one or more feature types.
...
create view cq_two_feature_type_features as
SELECT
