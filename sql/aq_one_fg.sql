...
--Beads--
create view aq_one_fg_beads as
SELECT
...
--Buckles--
create view aq_one_fg_buckles as
SELECT
"b"."ProjectName" AS "ProjectName",
"a"."ProjectID" AS "ProjectID",
string_agg(distinct COALESCE ("e"."FeatureNumber"), ', ')  "FeatureNumber",
...
"ArtifactType" ASC;
--Buttons--
create view aq_one_fg_buttons as
SELECT
"b"."ProjectName" AS "ProjectName",
"a"."ProjectID" AS "ProjectID",
string_agg(distinct COALESCE ("e"."FeatureNumber"), ', ')  "FeatureNumber",
...
"ArtifactType" ASC;
--Ceramics--
create view aq_one_fg_ceramics as
SELECT
"b"."ProjectName" AS "ProjectName",
"a"."ProjectID" AS "ProjectID",
string_agg(distinct COALESCE ("e"."FeatureNumber"), ', ')  "FeatureNumber",
...
"ArtifactType" ASC;
--Faunal--
create view aq_one_fg_bones as
SELECT
"b"."ProjectName" AS "ProjectName",
"a"."ProjectID" AS "ProjectID",
string_agg(distinct COALESCE ("e"."FeatureNumber"), ', ')  "FeatureNumber",
...
"ArtifactType" ASC;
--General Artifacts--
create view aq_one_fg_gen_artifacts as
SELECT
"b"."ProjectName" AS "ProjectName",
"a"."ProjectID" AS "ProjectID",
string_agg(distinct COALESCE ("e"."FeatureNumber"), ', ')  "FeatureNumber",
...
--Glass--
create view aq_one_fg_glasses as
SELECT
"b"."ProjectName" AS "ProjectName",
"a"."ProjectID" AS "ProjectID",
string_agg(distinct COALESCE ("e"."FeatureNumber"), ', ')  "FeatureNumber",
...
"ArtifactType" ASC;
--Tobacco Pipes--
create view aq_one_fg_tobacco_pipes as
SELECT
"b"."ProjectName" AS "ProjectName",
"a"."ProjectID" AS "ProjectID",
string_agg(distinct COALESCE ("e"."FeatureNumber"), ', ')  "FeatureNumber",
...
--Utensils--
create view aq_one_fg_utensils as
SELECT
"b"."ProjectName" AS "ProjectName",
"a"."ProjectID" AS "ProjectID",
string_agg(distinct COALESCE ("e"."FeatureNumber"), ', ')  "FeatureNumber",
