...
--Beads--
create view aq_one_fn_beads as
SELECT
...
--Buckles--
create view aq_one_fn_buckles as
SELECT
"b"."ProjectName" AS "ProjectName",
"a"."ProjectID" AS "ProjectID",
"e"."FeatureNumber" AS "FeatureNumber",
...
"ArtifactType" ASC;
--Buttons--
create view aq_one_fn_buttons as
SELECT
"b"."ProjectName" AS "ProjectName",
"a"."ProjectID" AS "ProjectID",
"e"."FeatureNumber" AS "FeatureNumber",
...
"ArtifactType" ASC;
--Ceramics--
create view aq_one_fn_ceramics as
SELECT
"b"."ProjectName" AS "ProjectName",
"a"."ProjectID" AS "ProjectID",
"e"."FeatureNumber" AS "FeatureNumber",
...
"ArtifactType" ASC;
--Faunal--
create view aq_one_fn_bones as
SELECT
"b"."ProjectName" AS "ProjectName",
"a"."ProjectID" AS "ProjectID",
"e"."FeatureNumber" AS "FeatureNumber",
...
"ArtifactType" ASC;
--General Artifacts--
create view aq_one_fn_gen_artifacts as
SELECT
"b"."ProjectName" AS "ProjectName",
"a"."ProjectID" AS "ProjectID",
"e"."FeatureNumber" AS "FeatureNumber",
...
--Glass--
create view aq_one_fn_glasses as
SELECT
"b"."ProjectName" AS "ProjectName",
"a"."ProjectID" AS "ProjectID",
"e"."FeatureNumber" AS "FeatureNumber",
...
"ArtifactType" ASC;
--Tobacco Pipes--
create view aq_one_fn_tobacco_pipes as
SELECT
"b"."ProjectName" AS "ProjectName",
"a"."ProjectID" AS "ProjectID",
"e"."FeatureNumber" AS "FeatureNumber",
...
--Utensils--
create view aq_one_fn_utensils as
SELECT
"b"."ProjectName" AS "ProjectName",
"a"."ProjectID" AS "ProjectID",
"e"."FeatureNumber" AS "FeatureNumber",
