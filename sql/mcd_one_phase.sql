...
--File Name: 	MCDQ1_Phase_DRC_Done
--Created by: Fraser Neiman
--Last Updated: 7 April 2015 by jeg

--Query Description: Query Returns MCD for Phases for one or more projects, subsetted by Phase.
--For DRC Site

create view mcd_one_phases as
SELECT
a."ProjectID",
"b"."ProjectName",
"c"."DAACSPhase",
