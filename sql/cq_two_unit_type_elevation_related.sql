--File Name: CQ2_UnitType__ElevationRelatedData_DRC_Done
--Created by: Jillian Galle
--Last Updated: 13 April 2015 by jeg

--Query Description: User selects one or more Projects, Unit Types, and Elevation Data in Related View.
...
create view cq_two_unit_type_elevation_relateds as
SELECT
