--File Name: CQ2_UnitType_NoRelatedData_DRC_Done
--Created by: Jillian Galle
--Last Updated: 15 June 2015 by jeg

--Query Description: User selects one or more Projects and one or more unit types.
...
create view cq_two_unit_type_no_relateds as
SELECT
a."Published",
...
--Unit Type Selection 
 "g"."UnitType" IN ('Feature', 'Quadrat/Unit')
