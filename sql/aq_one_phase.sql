--File Name: AQ1_Phase_DAACS_Done
--Created by: Jillian Galle
--Last Updated: 20 Feb 2015 by jeg

--Beads--
create view aq_one_phase_beads as
SELECT
...
--Buckles--
create view aq_one_phase_buckles as
SELECT
"b"."ProjectName" AS "ProjectName",
"a"."ProjectID" AS "ProjectID",
"c"."DAACSPhase" AS "DAACSPhase",
...
"ArtifactType" ASC;
--Buttons--
create view aq_one_phase_buttons as
SELECT
"b"."ProjectName" AS "ProjectName",
"a"."ProjectID" AS "ProjectID",
"c"."DAACSPhase" AS "DAACSPhase",
...
"ArtifactType" ASC;
--Ceramics--
create view aq_one_phase_ceramics as
SELECT
"b"."ProjectName" AS "ProjectName",
"a"."ProjectID" AS "ProjectID",
"c"."DAACSPhase" AS "DAACSPhase",
...
"ArtifactType" ASC;
--Faunal--
create view aq_one_phase_bones as
SELECT
"b"."ProjectName" AS "ProjectName",
"a"."ProjectID" AS "ProjectID",
"c"."DAACSPhase" AS "DAACSPhase",
...
"ArtifactType" ASC;
--General Artifacts--
create view aq_one_phase_gen_artifacts as
SELECT
"b"."ProjectName" AS "ProjectName",
"a"."ProjectID" AS "ProjectID",
"c"."DAACSPhase" AS "DAACSPhase",
...
--Glass--
create view aq_one_phase_glasses as
SELECT
"b"."ProjectName" AS "ProjectName",
"a"."ProjectID" AS "ProjectID",
"c"."DAACSPhase" AS "DAACSPhase",
...
"ArtifactType" ASC;
--Tobacco Pipes--
create view aq_one_phase_tobacco_pipes as
SELECT
"b"."ProjectName" AS "ProjectName",
"a"."ProjectID" AS "ProjectID",
"c"."DAACSPhase" AS "DAACSPhase",
...
--Utensils--
create view aq_one_phase_utensils as
SELECT
"b"."ProjectName" AS "ProjectName",
"a"."ProjectID" AS "ProjectID",
"c"."DAACSPhase" AS "DAACSPhase",
