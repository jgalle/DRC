--File Name: CQ2_UnitType_StratRelData_DRC_Done
--Created by: Jillian Galle
--Last Updated: 15 April 2015 by jeg

--Query Description: User selects one or more Projects, Unit Types, and Stratigraphic Relationship Data in Related View.
...
create view cq_two_unit_type_strat_relateds as
SELECT
